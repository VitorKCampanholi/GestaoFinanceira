...
namespace GestaoFinanceira.Migrations
{
    ...
    [Migration("20260822005959_DataBaseV8.0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gestao.Domain.FinancialTransction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("InteresPenalty")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("TypeFinancialTransction")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("FinancialTransctions");
                });

            modelBuilder.Entity("GestaoFinanceira.Domain.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Gestao.Domain.Company", b =>
                {
                    b.HasOne("GestaoFinanceira.Domain.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Gestao.Domain.Document", b =>
                {
                    b.HasOne("Gestao.Domain.FinancialTransction", "FinancialTransaction")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GestaoFinanceira.Domain.ApplicationUser", null)
                        .WithMany()
